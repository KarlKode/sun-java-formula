...
{%- set default_version_name = 'jdk1.8.0_92' %}
{%- set default_prefix       = '/usr/share/java' %}
{%- set default_source_url   = 'http://download.oracle.com/otn-pub/java/jdk/8u92-b14/jdk-8u92-linux-x64.tar.gz' %}
{%- set default_source_hash  = '79a3f25e9b466cb9e969d1772ea38550de320c88e9119bf8aa11ce8547c39987' %}
